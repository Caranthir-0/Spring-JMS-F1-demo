package edu.pja.sri.kobrebski.sri04jms.config;
...
public class JmsConfig {
    ...
    public static final String TOPIC_ONBOARD_MONITOR = "HELLO.TOPIC";
    public static final String QUEUE_SEND_AND_RECEIVE = "SEND_RECEIVE.QUEUE";
    public static final String MECHANIC_TOPIC = "mechanic.TOPIC";
