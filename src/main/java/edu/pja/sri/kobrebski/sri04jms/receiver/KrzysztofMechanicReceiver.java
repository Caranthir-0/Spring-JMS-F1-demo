...
@Component
public class KrzysztofMechanicReceiver {

    private static final Logger LOG = LoggerFactory.getLogger(KrzysztofMechanicReceiver.class);
    ...
    public void receiveMechanicMessage(@Payload MonitorPokladowyBolidu message,
                                       ...
                                       Message jmsMessage) {
        LOG.info("Kurza Twarz! Ile?!: {}", message);
    }
}